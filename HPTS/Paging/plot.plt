...
plot '10_tenants' using 1:6 with linespoints title "10-tenants with Paging" ls 1, \
'100_tenants' using 1:6 with linespoints title "100-tenants with Paging" ls 2,\
'1000_tenants' using 1:6 with linespoints title "1000-tenants with Paging" ls 3,\
'10000_tenants' using 1:6 with linespoints title "10000-tenants with Paging" ls 4
