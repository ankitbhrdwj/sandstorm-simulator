...
plot '10_PRE' using 4:6 with linespoints title "10-tenants with PRE" ls 5, \
'100_PRE' using 4:6 with linespoints title "100-tenants with PRE" ls 6,\
'1000_PRE' using 4:6 with linespoints title "1000-tenants with PRE" ls 7,\
'10000_PRE' using 4:6 with linespoints title "10000-tenants with PRE" ls 8
