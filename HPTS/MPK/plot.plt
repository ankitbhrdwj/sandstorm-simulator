...
plot '10_PRE' using 4:6 with linespoints title "10-tenants with PRE" ls 1, \
'100_PRE' using 4:6 with linespoints title "100-tenants with PRE" ls 2,\
'1000_PRE' using 4:6 with linespoints title "1000-tenants with PRE" ls 3,\
'10000_PRE' using 4:6 with linespoints title "10000-tenants with PRE" ls 4
