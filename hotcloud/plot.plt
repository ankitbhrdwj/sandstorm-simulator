...
plot '32_Paging' using 4:6 with linespoints title "10 Tenants with Paging" ls 1, \
'32_MPK' using 4:6 with linespoints title "10 Tenants with Mpk" ls 2,\
'32_VMFunc' using 4:6 with linespoints title "10 Tenants with VMFunc" ls 3
